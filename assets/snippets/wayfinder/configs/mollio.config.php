<?php
	...
	*/
	...
	#nav li ul {border-left: 1px solid #c00;background: #f6f6f6 url("assets/snippets/wayfinder/examples/mollio/images/featurebox_bg.gif") no-repeat 100% 100%;width:15.8em;margin-top:3px;position: absolute;left: -999em}
	...
	#nav li.active li.active a:link, #nav li.active li.active a:visited, #nav li.active li.active a:hover, #nav li.active li.active a:active {color:#fff;background: #666 url("assets/snippets/wayfinder/examples/mollio/images/sprites.gif") repeat-x 0 99%}
