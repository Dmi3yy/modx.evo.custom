...
class TinyMCE
{
	...
	function get_mce_script($params)
	{
		...
		case 'advanced':
		    ...
		    break;
		case 'full':
			$plugins  = 'autolink,pagebreak,style,layer,table,save,advhr,advimage,advlink,emotions,iespell,inlinepopups,insertdatetime,preview,media,youtubeIframe,searchreplace,print,contextmenu,paste,directionality,fullscreen,noneditable,visualchars,nonbreaking,xhtmlxtras,template,wordcount,advlist,autosave,youtubeIframe';
