...
function(){var a=c(this).parent(),b=a.attr("data-value"),e=c.inArray(b,g);-1!=e&&(g.splice(e,1),d.allowDoubling||(e=f.autocomplete("option","source"),e.push({label:a.attr("data-label"),value:b}),f.autocomplete("option","source",e)),0!=d.max&&f.show());a.remove()});e.on("click",function(){f.trigger("focus")}).on("click",function(){(0==d.max||g.length<d.max)&&a.trigger("ddMIopen")});f.on("focusin",function(a){e.addClass("focus")}).on("focusout",function(){e.removeClass("focus");a.val(g.join(d.separator))}).on("keydown",
