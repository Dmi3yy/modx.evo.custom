...
if (elFinder && elFinder.prototype && typeof(elFinder.prototype.i18) == 'object') {
	elFinder.prototype.i18.ru = {
		...
		messages   : {
			...
			'cmdhome'      : 'Домой',
			'cmdinfo'      : 'Свойства',
			'cmdmkdir'     : 'Создать папку',
			'cmdmkfile'    : 'Создать файл',
			'cmdopen'      : 'Открыть',
			'cmdpaste'     : 'Вставить',
			...
			'untitled folder' : 'new_folder',
			'untitled file.txt' : 'new_file.txt',
			...
			'errUploadFile'			: 'Невозможно загрузить "$1".',
			'errUploadTotalSize'	: 'Суммарный размер файлов превышает величину установленного ограничения.',
			'errUploadFileSize'		: 'Размер файла превышает величину установленного ограничения.'
