				...
				if($searchResultsArray) foreach($searchResultsArray as $searchResults)
				{
					...
					?>
						<tr>
							...
							<?php  } ?>
							<td class="functions">
								<a href="<?php echo $urlEdit; ?>" title="Edit"><img src="media/style<?php echo $theme; ?>/images/icons/save.png" alt="Edit" /></a>
								<a href="<?php echo $urlInfo; ?>" title="Info"><img src="media/style<?php echo $theme ;?>/images/tree/page-html.gif" alt="Info" /></a>								
