...
<head>
    ...
    <style type="text/css">
		...
		#login {
			background: #eeeeee url(media/style/MODxCarbon/images/body.jpg);
			margin: 12% 0 0;
		}
		#mx_loginbox {
			width: 309px;
		...
		#submitButton {
			...
			text-indent: -9999px;
		    margin: -7px 0 12px;
			background: url(media/style/MODxCarbon/images/misc/enter.png) no-repeat top left;
		}
		...
		#FMP-email_button {
			...
			text-indent: -9999px;
			width: 111px;
			background: url(media/style/MODxCarbon/images/misc/submit.png) no-repeat top left;
		}
		.loginLicense {
			width: 309px;
			margin: 0 auto;
