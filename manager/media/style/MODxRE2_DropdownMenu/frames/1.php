...
#tree iframe, #main iframe, #mask_resizer { position: absolute; width: 100%; height: 100%; }
#mainMenu iframe {position: absolute; width: 100%; height:48px;}
#mainMenu { height: 48px; width: 100%; box-shadow: 0px 2px 2px rgba(0, 0, 0, 0.25); z-index: 100; }
#tree {
...
#resizer #hideMenu { display: block; margin-top: 5px; margin-left: -8px; cursor: pointer; background: transparent url("media/style/<?php echo $modx->config['manager_theme']; ?>/images/icons/application_side_contract.png") no-repeat !important; width: 16px; height: 16px; }
#resizer2 { position: absolute; top: 48px; right: 20px; width: 3px; z-index: 110; }
