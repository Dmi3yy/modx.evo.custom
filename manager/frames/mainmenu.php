<?php
/*
menu->Build('id','parent','name','link','alt','onclick','permission','target','divider 1/0','menuindex', 'class', 'id')
*/

//mainMenu
$sitemenu['site']     = array('site','main',$_lang['site'],'#limenu3',$_lang['site'],'new NavToggle(this); return false;','','',0,10, 'active', 'limenu3');
$sitemenu['elements']     = array('elements','main',$_lang['elements'],'#limenu5',$_lang['elements'],'new NavToggle(this); return false;','','',0,20, '', 'limenu5');
$sitemenu['modules']     = array('modules','main',$_lang['modules'],'#limenu9',$_lang['modules'],'new NavToggle(this); return false;','','',0,30, '', 'limenu9');
$sitemenu['users']     = array('users','main',$_lang['users'],'#limenu2',$_lang['users'],'new NavToggle(this); return false;','edit_user','',0,40, '', 'limenu2');
$sitemenu['tools']     = array('tools','main',$_lang['tools'],'#limenu1-1',$_lang['tools'],'new NavToggle(this); return false;','','',0,50, '', 'limenu1-1');
$sitemenu['reports']     = array('reports','main',$_lang['reports'],'#limenu1-2',$_lang['reports'],'new NavToggle(this); return false;','','',0,60, '', 'limenu1-2');
