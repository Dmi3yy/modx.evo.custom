...
=======================================================
- удален EvoGallery (теперь в репозитории MODX-STORE)
- удален DocFinder (теперь в репозитории MODX-STORE)
- удален directResize (теперь в репозитории MODX-STORE)
- удален ajax_submit (теперь в репозитории MODX-STORE)
- удален markItUp! (теперь в репозитории MODX-STORE)
- удален CacheAccelerator (теперь в репозитории MODX-STORE)
- удален MultiPhotos (теперь в репозитории MODX-STORE)
- удален MultiFiles (теперь в репозитории MODX-STORE)
- удален fancybox (теперь в репозитории MODX-STORE)
- удален truncate (теперь в репозитории MODX-STORE)
- удален TreeTabs (теперь в репозитории MODX-STORE)
- удален TvTable (теперь в репозитории MODX-STORE)
- удален tvs_on_template (теперь в репозитории MODX-STORE)
- удален JotX (теперь в репозитории MODX-STORE)
- удален Reflect (теперь в репозитории MODX-STORE)
...
- добавлен модуль Store (первый репозиторий для MODX EVO http://modx-store.com)
