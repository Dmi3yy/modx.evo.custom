...
текущая версия 1.0.14-d6.16  (25.09.2014)
=======================================================
...
версия 1.0.14-d6.15  (06.06.2014)
=======================================================
- все исправления с версий 1.0.13RC2 до 1.0.14-d6.15 совпадают с правками официальной версии


версия 1.0.13RC2-d6.5  (19.12.2013)
=======================================================
...
- удален MemberCheck (теперь в репозитории Extras-Evolution)
- удален Personalize (теперь в репозитории Extras-Evolution)
- удален Weblogin (теперь в репозитории Extras-Evolution)
- удален ChoiceTV (теперь в репозитории Extras-Evolution)
- удален MultiTV (теперь в репозитории Extras-Evolution)
- удален AlwaysStay (теперь в репозитории Extras-Evolution)
- удален CfgTv (теперь в репозитории Extras-Evolution)
- удален customSettings (теперь в репозитории Extras-Evolution)
- удален customTemplate (теперь в репозитории Extras-Evolution)
- удален devStat (теперь в репозитории Extras-Evolution)
- удален Protect (теперь в репозитории Extras-Evolution)
- удален systemFiled (теперь в репозитории Extras-Evolution)
- удален searchHighlight (теперь в репозитории Extras-Evolution)
- удален parseChunk (теперь в репозитории Extras-Evolution)
- удален sitemap (теперь в репозитории Extras-Evolution)
- удален EvoGallery (теперь в репозитории Extras-Evolution)
- удален DocFinder (теперь в репозитории Extras-Evolution)
- удален directResize (теперь в репозитории Extras-Evolution)
- удален ajax_submit (теперь в репозитории Extras-Evolution)
- удален markItUp! (теперь в репозитории Extras-Evolution)
- удален CacheAccelerator (теперь в репозитории Extras-Evolution)
- удален MultiPhotos (теперь в репозитории Extras-Evolution)
- удален MultiFiles (теперь в репозитории Extras-Evolution)
- удален fancybox (теперь в репозитории Extras-Evolution)
- удален truncate (теперь в репозитории Extras-Evolution)
- удален TreeTabs (теперь в репозитории Extras-Evolution)
- удален TvTable (теперь в репозитории Extras-Evolution)
- удален tvs_on_template (теперь в репозитории Extras-Evolution)
- удален JotX (теперь в репозитории Extras-Evolution)
- удален Reflect (теперь в репозитории Extras-Evolution)
- исправленна ошибка при установке демоконтента
- исправленна ошибка когда в названии сайта присутствуют кавычки
- при обновлении проверьте настройки smtp (если использовали так как изменены немного параметры)
- исправлен баг схлопывания окна файлового менеджера
- добавлен модуль Store (первый репозиторий для MODX EVO http://extras.evolution-cms.com)

текущая версия 1.0.10-d5.4  (06.08.2013)
=======================================================
